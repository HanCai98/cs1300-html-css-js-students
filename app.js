...
const updatePage = async () => {
  ...
  const fruitsAfterFiltered = fruitsArray.filter(obj => obj.nutritions.sugar > 10);

  console.log(fruitsAfterFiltered)

  const mapped = fruitsAfterFiltered.map(obj => obj.name)
...
const exampleAddElement = (mapped) => {
